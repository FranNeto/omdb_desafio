...
public class ModelBO {
    ...
    private List<SearchFilms.Search> searchFilmsList;
    ...
    public void deleteFilmSelected(Filmes filmes, DetailsFragmentImpl detailsFragment){
        am = (EnviromentManager) AppApplication.getInstance().get(EnviromentManager.KEY);
        try {
            am.deleteFilm(filmes);
            detailsFragment.onSuccessoDelete("Filme deletado com sucesso!");
        } catch (SQLException e) {
            detailsFragment.onError("Erro ao deletar filme "+e.getMessage());
            Log.i("", "Erro ao deletar filme " + e.getMessage());
        } catch (Exception e) {
            detailsFragment.onError("Erro "+e.getMessage());
            Log.i("", "Erro:" + e.getMessage());
        }
    }

    public void addFilmes(Filmes filmes, DetailsFragmentImpl detailsFragment) {
        am = (EnviromentManager) AppApplication.getInstance().get(EnviromentManager.KEY);
        try {
            am.insertFilmes(filmes);
            detailsFragment.onSuccessoAdd("Salvo com Sucesso!");
        } catch (SQLException e) {
            detailsFragment.onError("Erro ao adicionar o filme "+ e.getMessage());
        } catch (Exception e) {
            detailsFragment.onError("Erro ao adicionar o filme "+ e.getMessage());
        }
    }
    ...
    public List<SearchFilms.Search> getSearchFilmsList() {
        return searchFilmsList;
    }

    public void setSearchFilmsList(List<SearchFilms.Search> searchFilmsList) {
        this.searchFilmsList = searchFilmsList;
    }
}
